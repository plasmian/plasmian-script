...
#Lutris key
curl https://download.opensuse.org/repositories/home:/strycore/Debian_Unstable/Release.key > /etc/apt/trusted.gpg.d/lutris.asc
blame_internet

#Repo modification
if [[ "$free" = "2" ]]
then
  printf "deb http://deb.debian.org/debian sid main contrib non-free\ndeb-src http://deb.debian.org/debian sid main contrib\ndeb https://dl.winehq.org/wine-builds/debian/ bookworm main\ndeb http://download.opensuse.org/repositories/home:/strycore/Debian_Unstable/ ./" > /etc/apt/sources.list
  apt update
  blame_internet
elif [ "$free" = "3" ]
then
...
apt upgrade -y
blame_internet
apt install -y bash-completion flatpak snapd neofetch kcharselect kamoso vlc elisa kolourpaint command-not-found grub-theme-breeze breeze-gtk-theme sddm-theme-breeze plymouth-theme-breeze winetricks wine-binfmt lutris plasma-discover-backend-flatpak plasma-systemmonitor
blame_internet
apt-file update
blame_internet
update-command-not-found
curl -L https://github.com/TheAssassin/AppImageLauncher/releases/download/v2.2.0/appimagelauncher_2.2.0-travis995.0f91801.bionic_amd64.deb -o /tmp/
apt install -y ./tmp/appimagelauncher_2.2.0-travis995.0f91801.bionic_amd64.deb

#Flatpak setup
flatpak remote-add flathub https://flathub.org/repo/flathub.flatpakrepo
flatpak remote-add flathub-beta https://flathub.org/beta-repo/flathub-beta.flatpakrepo
flatpak install -y --noninteractiveorg.onlyoffice.desktopeditors com.usebottles.bottles org.mozilla.Thunderbird com.github.tchx84.Flatseal io.github.prateekmedia.appimagepool
blame_internet
